...
export function SfcRendererPending() {
  return (
    <>
      <style>{`
        .genui-sfc-loading {
        ...
        .genui-sfc-loading .sk-title {
          height: 12px;
          width: 40%;
          animation-delay: 0.1s;
        }
        .genui-sfc-loading .sk-subtitle {
          height: 8px;
          width: 25%;
          animation-delay: 0.2s;
        }
        .genui-sfc-loading .sk-banner {
          height: 120px;
          width: 100%;
          border-radius: 10px;
      ...
      `}</style>
      <div className="genui-sfc-loading">
        <div className="sk-body">
          ...
          <div className="sk-block sk-banner" />
        </div>
      </div>
    </>
  )
